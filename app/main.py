...
def add_predictions(input_data):
    ...
    if predictions[0] == 0:
        ...
        st.write(
            "<span class='diagnosis malignant'>Malignant</span>", unsafe_allow_html=True
        )

    st.write(
        "The probability of being benign: ",
    ...
    st.write(
        "This app can assist medical professionals in making a diagnosis, but it should not be used as a substitute for a professional diagnosis"
    )
